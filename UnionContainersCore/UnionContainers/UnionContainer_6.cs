...
public sealed record UnionContainer<T1, T2, T3, T4, T5, T6> : UnionContainerBase<UnionContainer<T1,T2,T3,T4,T5,T6>>, IUnionContainer<UnionContainer<T1,T2,T3,T4,T5,T6>>,
    IResultTypeWrapper<T1,IResult1>, IResultTypeWrapper<T2,IResult2>, IResultTypeWrapper<T3,IResult3>, IResultTypeWrapper<T4,IResult4>, IResultTypeWrapper<T5,IResult5>, IResultTypeWrapper<T6,IResult6>
{
