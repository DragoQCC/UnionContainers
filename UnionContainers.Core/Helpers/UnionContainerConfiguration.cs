...
public class UnionContainerConfiguration
{
    ...
    {
        UnionContainerOptions = new UnionContainerOptions();
    ...
    public UnionContainerOptions UnionContainerOptions { get; }
}
...
public class UnionContainerOptions
{
    ...
    ///     Defaults to false
    /// </summary>
    public bool TreatExceptionsAsErrors { get; private set; }
    ...
    ///     Defaults to false
    /// </summary>
    public bool ThrowExceptionsFromUserHandlingCode { get; private set; }

    public ContainerLoggingOptions LoggingOptions { get; } = new();
...
public class ContainerLoggingOptions
{
    ...
    {
        ContainerCreationLogging = new ContainerCreationLogging(enabled, logLevel);
        UnionContainerConfiguration.UnionContainerOptionsInternal.LoggingOptions.ContainerCreationLogging = new ContainerCreationLogging(enabled, logLevel);
        return this;
    }

    public ContainerLoggingOptions SetContainerConversionLogging(bool enabled, LogLevel logLevel)
    {
        ContainerConversionLogging = new ContainerConversionLogging(enabled, logLevel);
        UnionContainerConfiguration.UnionContainerOptionsInternal.LoggingOptions.ContainerConversionLogging = new ContainerConversionLogging(enabled, logLevel);
        return this;
    }

    public ContainerLoggingOptions SetContainerModificationLogging(bool enabled, LogLevel logLevel)
    {
        ContainerModificationLogging = new ContainerModificationLogging(enabled, logLevel);
        UnionContainerConfiguration.UnionContainerOptionsInternal.LoggingOptions.ContainerModificationLogging = new ContainerModificationLogging(enabled, logLevel);
        return this;
    }

    public ContainerLoggingOptions SetContainerResultHandlingLogging(bool enabled, LogLevel logLevel)
    {
        ContainerResultHandlingLogging = new ContainerResultHandlingLogging(enabled, logLevel);
        UnionContainerConfiguration.UnionContainerOptionsInternal.LoggingOptions.ContainerResultHandlingLogging = new ContainerResultHandlingLogging(enabled, logLevel);
        return this;
    }

    public ContainerLoggingOptions SetContainerErrorHandlingLogging(bool enabled, LogLevel logLevel)
    {
        ContainerErrorHandlingLogging = new ContainerErrorHandlingLogging(enabled, logLevel);
        UnionContainerConfiguration.UnionContainerOptionsInternal.LoggingOptions.ContainerErrorHandlingLogging = new ContainerErrorHandlingLogging(enabled, logLevel);
        return this;
    }
}