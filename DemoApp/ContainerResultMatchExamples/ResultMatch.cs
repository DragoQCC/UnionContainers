...
public class ResultMatch
{
    ...
    public static void DeconstructionMatch()
    {
        ...
        if (container is (Programmer employee, _))
        {
    ...
    {
        UnionContainer<Programmer> container = GetEmployeeByNameOrId("Jane Doe");
        if (container.HasResult())
        {
            Programmer employee1 = container.TryGetValue().ThrowIfNull();
    ...
    public static void TryGetValueFallbacks()
    {
        ...
        string containerValue2 = container.TryGetValue
        (
            fallbackValueMethod: () =>
            {
    ...
    public static void HandleResultExamples()
    {
        ...
        UnionContainer<Programmer, ManagerInTraining> containerTwo = programmer;
        containerTwo
            .IfEmptyDo(() => Console.WriteLine("Container is empty"))
            .MatchResult((Programmer employee) => Console.WriteLine($"Container value is an employee \n\t{employee}"))
