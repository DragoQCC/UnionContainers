...
{
    // demo components
    public static Programmer programmer = new("John Doe", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow);
    ...
    public static List<Programmer> employees = new()
    {
        new Programmer("John Doe", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow),
        new Programmer("Jane Doe", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow),
        new Programmer("Bob Stevens", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow),
        new Programmer("Sally Stevens", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow),
        new Programmer("Joe Stevens", Guid.NewGuid(), "Manager", 100000, DateTime.UtcNow)
    };
    ...
    private static async Task Main(string[] args)
    {
        ...
        builder.Services.AddUnionContainerConfiguration
        (
            options =>
            {
        ...
        var containerConfiguration = app.Services.GetRequiredService<UnionContainerConfiguration>();
    ...
    public static UnionContainer<Programmer, Manager> GetEmployeeOrManagerByNameOrId(UnionContainer<string, Guid> nameOrId)
    {
        ...
        var employees = new List<Programmer>
        {
            new("John Doe", Guid.NewGuid(), "Employee", 100000, DateTime.UtcNow),
            new("Jane Doe", Guid.NewGuid(), "Employee", 100000, DateTime.UtcNow),
            new("Bob Doe", Guid.NewGuid(), "Employee", 100000, DateTime.UtcNow),
            new("Sally Doe", Guid.NewGuid(), "Employee", 100000, DateTime.UtcNow),
            new("Joe Doe", Guid.NewGuid(), "Employee", 100000, DateTime.UtcNow)
        };

        var managers = new List<Manager>
        {
            new("John Stevens", Guid.NewGuid(), "Manager", 150000, DateTime.UtcNow),
            new("Jane Stevens", Guid.NewGuid(), "Manager", 150000, DateTime.UtcNow),
            new("Bob Stevens", Guid.NewGuid(), "Manager", 150000, DateTime.UtcNow),
            new("Sally Stevens", Guid.NewGuid(), "Manager", 150000, DateTime.UtcNow),
            new("Joe Stevens", Guid.NewGuid(), "Manager", 150000, DateTime.UtcNow)
        };
        ...
        {
            ({
            } name, _) => employees.FirstOrDefault(e => e.Name == name) ?? managers.FirstOrDefault(m => m.Name == name) ?? new UnionContainer<Programmer, Manager>(),
            (_, Guid id) => employees.FirstOrDefault(e => e.ID == id) ?? managers.FirstOrDefault(m => m.ID == id) ?? new UnionContainer<Programmer, Manager>()
        };
    }
